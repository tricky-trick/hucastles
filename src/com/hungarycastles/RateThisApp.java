...
public class RateThisApp {
	...
	public static void showRateDialog(final Context context) {
		...
		builder.setTitle(context.getString(context.getResources().getIdentifier(
				"rta_dialog_title" + prefix, "string",
				context.getPackageName())));
		builder.setMessage(context.getString(context.getResources().getIdentifier(
				"rta_dialog_message" + prefix, "string",
				context.getPackageName())));
		builder.setPositiveButton(context.getString(context.getResources().getIdentifier(
				"rta_dialog_ok" + prefix, "string",
				context.getPackageName())), new OnClickListener() {
			@Override
		...
		builder.setNeutralButton(context.getString(context.getResources().getIdentifier(
				"rta_dialog_cancel" + prefix, "string",
				context.getPackageName())), new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
		...
		builder.setNegativeButton(context.getString(context.getResources().getIdentifier(
				"rta_dialog_no" + prefix, "string",
				context.getPackageName())), new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				setOptOut(context, true);
